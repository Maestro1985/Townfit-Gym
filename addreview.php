                        ...
                        <div class="offset-xl-4 col-xl-4 offset-lg-4 col-lg-4 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label class="control-label sr-only" for="comments"></label>
                                                <input id="comments" type="text" placeholder="comments" class="form-control"  name="comments">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mt20">
                                            ...
                                            <button class="btn btn-default" type="submit" name="sub">Submit</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
