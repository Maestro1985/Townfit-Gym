...
<body>
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-4 col-sm-12 col-12">
                        <div class="quick-info">
                            ...
                            <span class="quick-info-text"><a href="#" class="quick-info-link">Login</a></span>
                            <span class="quick-info-text"><a href="#" class="quick-info-link">Register</a></span>
                        </div>
                    </div>
	...
	include('connect.php');
     ...
     $sql="INSERT INTO `Contact`( `First Name`,`Last name`,`Email`,`Phone`,`Content`) VALUES ('".$_POST['Firstname']."','".$_POST['Lastname']."','".$_POST['Email']."','".$_POST['Phone']."','".$_POST['content']."')";
