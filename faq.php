...
$res=$conn->query ("select * from faqs");
...
echo '<div class="accordion-card card">';
echo '<div class="accordion-card-header active" id="headingOne">';
echo '<h5 class="mb-0">';
echo '<a role="button" href="#" class="accordion-card-title" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">';
echo $r["Question"]; 
echo '<span class="fa fa-angle-down float-right"></span> </a></h5>';
echo '</div>';
